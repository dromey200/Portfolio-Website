...
function initializePortfolio() {
    ...
    function getLocalizedProjectData(projectId) {
        ...
        const extendedDescriptions = {
            'horadric-companion': 'Designed a multi-modal AI agent to solve "analysis paralysis" in complex ARPGs like Diablo. Players often hoard hundreds of items because the math required to know if a new item is a true upgrade is overwhelming, leading to stalled progression and churn.<br><br><strong>The Solution:</strong> Instead of tedious manual entry into calculators, Stat Verdict uses Computer Vision (CV) to instantly "read" item stats from screenshots uploaded by the user. The AI then acts as a personalized "Loot Coach," comparing the drop against meta-data to offer mathematically backed build pivots.<br><br><strong>Validated Outcomes:</strong><br>• <strong>Time-to-Verdict:</strong> End-to-end analysis in 1.4 seconds average on mobile — fast enough to compete with in-game momentum.<br>• <strong>User Acquisition:</strong> 55+ active users within 48 hours of V1 launch, zero paid marketing.<br>• <strong>Engagement:</strong> 12m 47s average engaged session among users who cleared the friction barrier.<br><br><br>👇 <strong>Explore the Design:</strong><br><div style="display: flex; gap: 15px; margin-top: 10px; flex-wrap: wrap;"><a href="statverdict-case-study.html" style="color: #6a89cc; font-weight: bold; text-decoration: none;">📄 Read the Case Study</a><a href="https://www.statverdict.com" target="_blank" rel="noopener noreferrer" style="color: #6a89cc; font-weight: bold; text-decoration: none;">🚀 Try Stat Verdict Live</a></div>',
